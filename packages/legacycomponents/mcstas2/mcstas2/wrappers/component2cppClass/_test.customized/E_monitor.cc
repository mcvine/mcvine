...
mcstas2::E_monitor::E_monitor
(int in_nchan,char * in_filename,double in_xmin,double in_xmax,double in_ymin,double in_ymax,double in_Emin,double in_Emax)
{
    nchan = in_nchan;
...
// Generated automatically by CCMill on Fri Jan 18 15:19:28 2008
