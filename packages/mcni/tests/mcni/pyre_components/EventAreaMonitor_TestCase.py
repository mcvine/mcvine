...
instrument1_output = 'out-EventAreaMonitor_TestCase-instrument1'
instrument2_output = 'out-EventAreaMonitor_TestCase-instrument2'
...
# version
__id__ = "$Id: neutron_storage_TestCase.py 1126 2011-04-10 03:05:40Z linjiao $"
