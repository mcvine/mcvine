...
class DetectorSystem(MultiMonitors):
    ...
    def _configure(self):
        ...
        m2.inventory.wmin    = self.inventory.wmin
        m2.inventory.wmax    = self.inventory.wmax
        m2.inventory.nw      = self.inventory.nw
        ...
        m4.inventory.wmin    = self.inventory.wmin
        m4.inventory.wmax    = self.inventory.wmax
        m4.inventory.nw      = self.inventory.nw
        ...
        m6.inventory.wmin    = self.inventory.wmin
        m6.inventory.wmax    = self.inventory.wmax
        m6.inventory.nw      = self.inventory.nw
